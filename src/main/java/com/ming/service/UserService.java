...
import com.ming.entity.UserGroup;
...
/**
 * @author Created by ming on 2018-01-08 13:55
 */
@Service
public class UserService {
    ...
    private List<com.ming.entity.User> toMyUser(List<User> userList) {
        List<com.ming.entity.User> myUserList = new ArrayList<>();
        for (User user : userList) {
            com.ming.entity.User myUser = new com.ming.entity.User();
    ...
    public Object addUser(com.ming.entity.User user) {
